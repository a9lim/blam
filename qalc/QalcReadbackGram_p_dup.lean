...
namespace QalcReadbackGram_p_dup
...
def machine : Machine := #[
    ...
    { hadamard := true, entries := [(74, ⟨1, 0, 0, 0, 1⟩), (75, ⟨1, 0, 0, 0, 1⟩)] },
    { hadamard := false, entries := [(90, ⟨1, 0, 0, 0, 0⟩)] },
    { hadamard := false, entries := [(91, ⟨1, 0, 0, 0, 0⟩)] },
    { hadamard := true, entries := [(77, ⟨1, 0, 0, 0, 1⟩), (78, ⟨1, 0, 0, 0, 1⟩)] },
