...
namespace QalcReadbackGram_p_palpha
...
def machine : Machine := #[
    ...
    { hadamard := true, entries := [(124, ⟨1, 0, 0, 0, 1⟩), (125, ⟨-1, 0, 0, 0, 1⟩)] },
