...
namespace QalcReadbackGram_p_weave
...
def machine : Machine := #[
    ...
    { hadamard := true, entries := [(125, ⟨1, 0, 0, 0, 1⟩), (126, ⟨1, 0, 0, 0, 1⟩)] },
    { hadamard := false, entries := [(139, ⟨1, 0, 0, 0, 0⟩)] },
    { hadamard := false, entries := [(140, ⟨1, 0, 0, 0, 0⟩)] },
    { hadamard := true, entries := [(128, ⟨1, 0, 0, 0, 1⟩), (129, ⟨1, 0, 0, 0, 1⟩)] },
    ...
    { hadamard := true, entries := [(241, ⟨1, 0, 0, 0, 1⟩), (242, ⟨1, 0, 0, 0, 1⟩)] },
