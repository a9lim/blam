...
namespace QalcReadbackGram_p_3coin
...
def machine : Machine := #[
    ...
    { hadamard := true, entries := [(97, ⟨1, 0, 0, 0, 1⟩), (98, ⟨1, 0, 0, 0, 1⟩)] },
    ...
    { hadamard := true, entries := [(120, ⟨1, 0, 0, 0, 1⟩), (121, ⟨1, 0, 0, 0, 1⟩)] },
    ...
    { hadamard := true, entries := [(143, ⟨1, 0, 0, 0, 1⟩), (144, ⟨1, 0, 0, 0, 1⟩)] },
