...
namespace QalcReadbackGram_p_stress_spine3
...
def machine : Machine := #[
    ...
    { hadamard := true, entries := [(122, ⟨1, 0, 0, 0, 1⟩), (124, ⟨-1, 0, 0, 0, 1⟩)] },
    { hadamard := true, entries := [(123, ⟨1, 0, 0, 0, 1⟩), (125, ⟨-1, 0, 0, 0, 1⟩)] },
    ...
    { hadamard := false, entries := [(155, ⟨0, 1, 0, 0, 0⟩)] },
    { hadamard := false, entries := [(156, ⟨0, 1, 0, 0, 0⟩)] },
    ...
    { hadamard := true, entries := [(180, ⟨1, 0, 0, 0, 1⟩), (181, ⟨1, 0, 0, 0, 1⟩)] },
...
end QalcReadbackGram_p_stress_spine3
