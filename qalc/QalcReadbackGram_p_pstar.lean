...
namespace QalcReadbackGram_p_pstar
...
def machine : Machine := #[
    ...
    { hadamard := true, entries := [(119, ⟨1, 0, 0, 0, 1⟩), (121, ⟨1, 0, 0, 0, 1⟩)] },
    { hadamard := true, entries := [(120, ⟨1, 0, 0, 0, 1⟩), (122, ⟨1, 0, 0, 0, 1⟩)] },
