...
namespace QalcReadbackGram_p_hweave
...
def machine : Machine := #[
    ...
    { hadamard := true, entries := [(98, ⟨1, 0, 0, 0, 1⟩), (100, ⟨1, 0, 0, 0, 1⟩)] },
    { hadamard := true, entries := [(99, ⟨1, 0, 0, 0, 1⟩), (101, ⟨1, 0, 0, 0, 1⟩)] },
    ...
    { hadamard := true, entries := [(174, ⟨1, 0, 0, 0, 1⟩), (175, ⟨1, 0, 0, 0, 1⟩)] },
