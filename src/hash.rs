...
/// SHA-256 of a byte string, the whole message in memory. The standard
/// "abc" and empty-string vectors plus both padding boundaries are
...
/// and the qALC fixture commitments store.
