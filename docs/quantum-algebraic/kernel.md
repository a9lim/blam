...
`~/Work/qalc-scratch/GATE1.md`; the live Gate-2 obstruction and rejected
construction record is `~/Work/qalc-scratch/GATE2.md`, and the selected
native-CNOT experiment is specified in `~/Work/qalc-scratch/GATE2_CNOT.md`.
