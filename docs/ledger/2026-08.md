...
entry carries the history; the architecture states only the contract),
with a third full-sign-off review pass to follow before any
formalization work begins.
